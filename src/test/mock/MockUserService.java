...
public class MockUserService {
    public static User user = new User("User", "sergiovanovi@mail.ru", PasswordUtil.encode("123123"), -5, 5);
    public static User admin = new User("Admin", "inbox@sergiovanovi.com", PasswordUtil.encode("123456"), -10, 10);
